...
import lucky.gameFunctions.PropertiesLoader;
...
public class TestScoring {
    class RoundData {
        ...
        public String toString() {
            return "Round " + roundNumber + ". Player Selections: " +
                    playerSelections + ". Scores: " +
                    playerScores[0] + "," + playerScores[1] + "," + playerScores[2]
                    + "," + playerScores[3];
        }
    }
    ...
    private Scanner runningGame(String propertiesFile) {
        final Properties properties =
                PropertiesLoader.loadPropertiesFile(propertiesFile);
